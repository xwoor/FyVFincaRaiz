                ...
                <form action="/admin"  method="POST" enctype="multipart/form-data">
                  @csrf
                    ...
                    <div class="form-group col-md-12">
                        <label for="">Decripción detallada</label>
